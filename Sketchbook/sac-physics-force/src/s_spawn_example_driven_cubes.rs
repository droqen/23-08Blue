use ambient_api::{
    core::{
        ...
        physics::{
            components::{cube_collider, visualize_collider, physics_controlled, dynamic, linear_velocity}, self}, rendering::components::color,
        },
    prelude::*,
};
...
pub fn setup() {
    ...
    query(driven_power()).each_frame(|driven_bodies|{
        for (body,power) in driven_bodies {
            ...
            ambient_api::physics::add_force(body, vec3(-power, 0., 0.,));
        }
    });
