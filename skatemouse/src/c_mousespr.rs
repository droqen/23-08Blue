use ambient_api::{
    ...
    core::{
        ...
        primitives::concepts::make_capsule,
        model::components::model_from_url,
    },
};

use crate::embers::skatemouse::components::{is_skatemouse, mouse_cheese, mouse_fwd, is_mouse_spr, is_cheese_spr, mouse_spr_fwd, };
...
pub fn setup() {
    spawn_query((translation(), is_skatemouse())).bind(|mice|for(mouse,(pos,cheese)) in mice{
        let mouse_spr = Entity::new()
            ...
            .with(model_from_url(), crate::embers::skatemouse::assets::url("low_poly_rat.glb"))
